                ...
                <div class="mb-8 bg-slate-900/80 backdrop-blur-sm rounded-2xl p-2 border border-slate-800/80">
                    <nav class="flex space-x-4">
                        ...
                        <button @click="activeTab = 'events'"
                            :class="{ 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white': activeTab === 'events' }"
                            class="flex items-center px-6 py-3 text-sm font-medium rounded-lg text-gray-300 hover:text-white transition-all duration-300">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button @click="activeTab = 'reports'"
                            :class="{ 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white': activeTab === 'reports' }"
                            class="flex items-center px-6 py-3 text-sm font-medium rounded-lg text-gray-300 hover:text-white transition-all duration-300">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
